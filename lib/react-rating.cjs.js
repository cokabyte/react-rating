...
function (_React$PureComponent) {
  ...
  _createClass(RatingSymbol, [{
    ...
    value: function render() {
      ...
      }, backgroundNode), React__default["default"].createElement("span", {
  ...
  return RatingSymbol;
}(React__default["default"].PureComponent); // Define propTypes only in development. They will be void in production.
...
function (_React$PureComponent) {
  ...
  function Rating(props) {
    ...
    _this.symbolEnd = _this.symbolEnd.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  ...
  _createClass(Rating, [{
    ...
    value: function render() {
      ...
      for (var i = 0; i < totalSymbols; i++) {
        ...
        symbolNodes.push(React__default["default"].createElement(RatingSymbol, _extends({
          key: i,
          index: i,
          readonly: readonly,
  ...
  return Rating;
}(React__default["default"].PureComponent); // Define propTypes only in development.
...
function (_React$PureComponent) {
  ...
  _createClass(RatingAPILayer, [{
    ...
    value: function render() {
      ...
      return React__default["default"].createElement(Rating, {
        id: id,
        style: style,
        className: className,
        tabIndex: tabIndex,
